...
export default function VideoSection() {
  return (
    <section className="overflow-hidden py-24! px-8! flex justify-center items-center bg-white text-black text-center relative">
      <div className="max-w-5xl w-full mx-auto overflow-hidden">
        <motion.div
        ...
        >
          <div className="flex flex-col md:flex-row-reverse lg:flex-col md:items-center md:justify-between gap-12 text-center md:text-left w-full">
            <div className="min-w-0 md:w-2/3 lg:w-full">
            ...
            <div className="min-w-0 md:w-1/3 lg:w-full md:h-96 lg:h-auto md:flex lg:block items-center justify-center">
              <div className="w-full max-w-full h-[15rem] md:h-64 lg:h-full relative group rounded-2xl overflow-hidden aspect-video">
